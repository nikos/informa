...
public abstract class TestAbstractPersistenceManager extends TestCase {
    ...
    public void testDeleteGroup() {
        try {
            // Create simple group
            ChannelGroupIF group = manager.createGroup(tuids1);
    ...
    /**
     * Tests how concurrent creation of items works.
     */
    public void testConcurrentItemCreation() {
        ...
        // Create new thread which will be waiting for notification to start creation of 10 items
